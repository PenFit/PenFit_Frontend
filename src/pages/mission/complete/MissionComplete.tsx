      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-24">
        {isLoading ? (
          <>
            ...
            <p className="text-sm text-foreground-500">완료 결과를 불러오는 중...</p>
          </>
        ) : isError || !latestCompletion ? (
          <>
            <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-background-100">
            ...
            <p className="mb-6 text-center text-sm leading-relaxed text-foreground-500">
              이번 주 미션을 완료하면 결과를 확인할 수 있어요.
            </p>
            <button
              type="button"
