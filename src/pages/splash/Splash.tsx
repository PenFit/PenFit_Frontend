  ...
  return (
    <main className="flex min-h-screen flex-col bg-[oklch(var(--background-50))]">
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-6 pb-20">
        ...
        <h1 className="mb-4 font-heading text-2xl font-bold text-[oklch(var(--foreground-950))]">
          PenFit
        </h1>

        <p className="text-center text-sm leading-relaxed text-[oklch(var(--foreground-700))]">
